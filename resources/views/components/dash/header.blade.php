...
<head>
    ...
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets') }}/assets/img/favicons/rbj2.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('assets') }}/assets/img/favicons/rbj2.png">
    ...
    <meta name="msapplication-TileImage" content="{{ asset('assets') }}/assets/img/favicons/rbj2.png">
